...
Partial Class Form2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Plese Select Desired Calculator"
        '
        'Button1
        '
